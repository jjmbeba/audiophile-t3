...
const Hero = () => {
  return (
    <section className="relative pb-[7rem] text-center md:pb-[10.4375rem]">
      <HeroImage />
      <div className="flex flex-col items-center md:*:max-w-[24.9875rem]">
        ...
        <p className="mt-[2.3125rem] text-[#c5c5c5] md:mt-[2.4375rem] md:px-[2rem]">
